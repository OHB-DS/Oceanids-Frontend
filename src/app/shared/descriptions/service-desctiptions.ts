export const serviceDescriptions: { [key: string]: string } = {
    'coastal_change': '<h2>Coastal Change Service</h2>' +
        '<ul>' +
    ...
    'ground_motion': '<h2>Ground Motion Service</h2>' +
        '<ul>' +
    ...
    'wave_climate': '<h2>Wave Climate Service</h2>' +
        '<ul>' +
    ...
    'sea_level': '<h2>Sea Level Service</h2>' +
        '<ul>' +
        ...
        '<li><strong>Data Source:</strong> The data is obtained from <a href="https://www.euro-cordex.net/">EURO-CORDEX</a> models (CMCC-CM2-VHR4 and EC-Earth2P-HR) at the closest grid point.</li>' +
        '</ul>',
